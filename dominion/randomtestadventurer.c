...
int main(){
	printf("Random Adventurer Starting \n");
	...
	for(i=0;i < MAX_TESTS;i++){
		...
		cardEffect(adventurer,1,1,1,&state1);
	}
	...
	for(i=0;i < MAX_TESTS;i++){
			...
			cardEffect(adventurer,1,1,1,&state2);
		}
	...
	for(i=0;i < MAX_TESTS;i++){
		...
		cardEffect(adventurer,1,1,1,&state3);
	}

	printf("Random Test Adventurer Complete \n");
